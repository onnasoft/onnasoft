...
export default async function ServicesMenu({ language }: ServicesMenuProps) {
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute z-10 mt-1 left-1/2 transform -translate-x-1/2 min-w-[650px] rounded-md shadow-lg bg-white ring-1 ring-slate-200 ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
