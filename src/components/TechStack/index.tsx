...
export const techIcons = {
  ...
  SonarQube: <SiSonarqubecloud className="text-2xl" />,
  ...
  AWS: <FaAmazon className="text-2xl" />,
  ...
  "AWS CloudWatch": <FaAmazon className="text-2xl" />,
  "AWS CloudTrail": <FaAmazon className="text-2xl" />,
  AWSConfig: <FaAmazon className="text-2xl" />,
